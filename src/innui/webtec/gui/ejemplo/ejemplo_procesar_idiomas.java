...
import static innui.webtec.gui.ejemplo.ejemplo_idiomas.k_menu_in_idioma;
...
public class ejemplo_procesar_idiomas extends A_ejecutores {
    public static String k_ejemplo_procesar_idiomas = "innui_webtec_gui_ejemplo_ejemplo_procesar_idiomas"; //NOI18N
    ...
    public boolean ejecutar(Map<String, Object> objects_mapa, String[] error) {
        ...
        try {
            ...
            if (ret) {
                objects_mapa.put(k_ejemplo_procesar_idiomas, string_webtec_controlador.contenido);
            } else {
                objects_mapa.put(k_ejemplo_procesar_idiomas, error[0]);
            }               
        } catch (Exception e) {
