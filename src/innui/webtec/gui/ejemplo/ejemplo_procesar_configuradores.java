 ...
 */
public class ejemplo_procesar_configuradores extends A_ejecutores {
    public static String k_mapa_ejemplo_procesar_configuradores_errores = "innui_webtec_gui_ejemplo_ejemplo_procesar_configuradores_errores"; //NOI18N
    public static String k_prefijo_configuraciones = "innui_webtec_gui_ejemplo_configuraciones_";
    /**
    ...
    public boolean ejecutar(Map<String, Object> objects_mapa, String[] error) {
        ...
        try {
            ...
            error[0] = java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("in/innui/webtec/gui/ejemplo/in").getString("ERROR AL EJECUTAR EN EJEMPLO_PROCESAR_CONFIGURADORES. {0}"), new Object[] {error[0]});
            ret = false;
        }
        return ret;
    }
